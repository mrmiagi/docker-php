...
class HostConfigNormalizer extends SerializerAwareNormalizer implements DenormalizerInterface, NormalizerInterface
{
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (property_exists($data, 'Dns')) {
            ...
            $object->setDns($value_17);
        }
        if (property_exists($data, 'DnsSearch')) {
            $value_19 = $data->{'DnsSearch'};
            ...
            $object->setDnsSearch($value_19);
        }
        if (property_exists($data, 'ExtraHosts')) {
            $value_21 = $data->{'ExtraHosts'};
            if (is_array($data->{'ExtraHosts'})) {
                $values_11 = [];
                foreach ($data->{'ExtraHosts'} as $value_22) {
                    $values_11[] = $value_22;
                }
                $value_21 = $values_11;
            }
            ...
            $object->setExtraHosts($value_21);
        }
        if (property_exists($data, 'VolumesFrom')) {
            $value_23 = $data->{'VolumesFrom'};
            if (is_array($data->{'VolumesFrom'})) {
                $values_12 = [];
                foreach ($data->{'VolumesFrom'} as $value_24) {
                    $values_12[] = $value_24;
                }
                $value_23 = $values_12;
            }
            ...
            $object->setVolumesFrom($value_23);
        }
        if (property_exists($data, 'CapAdd')) {
            $value_25 = $data->{'CapAdd'};
            if (is_array($data->{'CapAdd'})) {
                $values_13 = [];
                foreach ($data->{'CapAdd'} as $value_26) {
                    $values_13[] = $value_26;
                }
                $value_25 = $values_13;
            }
            ...
            $object->setCapAdd($value_25);
        }
        if (property_exists($data, 'CapDrop')) {
            $value_27 = $data->{'CapDrop'};
            if (is_array($data->{'CapDrop'})) {
                $values_14 = [];
                foreach ($data->{'CapDrop'} as $value_28) {
                    $values_14[] = $value_28;
                }
                $value_27 = $values_14;
            }
        ...
        if (property_exists($data, 'Devices')) {
            $value_29 = $data->{'Devices'};
            if (is_array($data->{'Devices'})) {
                $values_15 = [];
                foreach ($data->{'Devices'} as $value_30) {
                    $values_15[] = $this->serializer->deserialize($value_30, 'Docker\\API\\Model\\Device', 'raw', $context);
                }
                $value_29 = $values_15;
            }
            ...
            $object->setDevices($value_29);
        }
        if (property_exists($data, 'Ulimits')) {
            $value_31 = $data->{'Ulimits'};
            if (is_array($data->{'Ulimits'})) {
                $values_16 = [];
                foreach ($data->{'Ulimits'} as $value_32) {
                    $values_16[] = $this->serializer->deserialize($value_32, 'Docker\\API\\Model\\Ulimit', 'raw', $context);
                }
                $value_31 = $values_16;
            }
            ...
            $object->setUlimits($value_31);
        }
        if (property_exists($data, 'SecurityOpt')) {
            $value_33 = $data->{'SecurityOpt'};
            if (is_array($data->{'SecurityOpt'})) {
                $values_17 = [];
                foreach ($data->{'SecurityOpt'} as $value_34) {
                    $values_17[] = $value_34;
                }
                $value_33 = $values_17;
            }
            ...
            $object->setSecurityOpt($value_33);
        }
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        $data->{'DnsSearch'} = $value_19;
        $value_21 = $object->getExtraHosts();
        if (is_array($object->getExtraHosts())) {
            $values_11 = [];
            foreach ($object->getExtraHosts() as $value_22) {
                $values_11[] = $value_22;
            }
            $value_21 = $values_11;
        }
        ...
        $data->{'ExtraHosts'} = $value_21;
        $value_23 = $object->getVolumesFrom();
        if (is_array($object->getVolumesFrom())) {
            $values_12 = [];
            foreach ($object->getVolumesFrom() as $value_24) {
                $values_12[] = $value_24;
            }
            $value_23 = $values_12;
        }
        ...
        $data->{'VolumesFrom'} = $value_23;
        $value_25 = $object->getCapAdd();
        if (is_array($object->getCapAdd())) {
            $values_13 = [];
            foreach ($object->getCapAdd() as $value_26) {
                $values_13[] = $value_26;
            }
            $value_25 = $values_13;
        }
        ...
        $data->{'CapAdd'} = $value_25;
        $value_27 = $object->getCapDrop();
        if (is_array($object->getCapDrop())) {
            $values_14 = [];
            foreach ($object->getCapDrop() as $value_28) {
                $values_14[] = $value_28;
            }
            $value_27 = $values_14;
        }
        ...
        $value_29 = $object->getDevices();
        if (is_array($object->getDevices())) {
            $values_15 = [];
            foreach ($object->getDevices() as $value_30) {
                $values_15[] = $this->serializer->serialize($value_30, 'raw', $context);
            }
            $value_29 = $values_15;
        }
        ...
        $data->{'Devices'} = $value_29;
        $value_31 = $object->getUlimits();
        if (is_array($object->getUlimits())) {
            $values_16 = [];
            foreach ($object->getUlimits() as $value_32) {
        ...
        $data->{'Ulimits'} = $value_31;
        $value_33 = $object->getSecurityOpt();
        if (is_array($object->getSecurityOpt())) {
            $values_17 = [];
            foreach ($object->getSecurityOpt() as $value_34) {
                $values_17[] = $value_34;
            }
            $value_33 = $values_17;
        }
